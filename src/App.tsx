          ...
          <div className="space-y-10 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 text-center space-y-2">
                  ...
                  <p className="text-[10px] text-slate-500 leading-relaxed text-justify">
                    本网站所有列示的学术成果、论文公式、证书印章及社会实践经历，均经过官方文件核发和真实性查验。点击行项目即可查看高保真验证详情。
                  </p>
                </div>
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                {/* CV Section 4: Work & Practical Experience */}
                <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-4 shadow-xs">
                  <div className="flex justify-between items-center border-b border-slate-100 pb-2.5">
                    <h3 className="text-base font-bold text-slate-900 tracking-tight flex items-center gap-2">
                      <Briefcase className="w-5 h-5 text-emerald-600" />
                      <span>工作与实践经历 ({EXPERIENCES.length})</span>
                    </h3>
                    <span className="text-[10px] text-slate-400 font-mono">点击查看官方盖章原件校验</span>
                  </div>
                        ...
                        <div className="space-y-1.5 flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className={`text-[9px] font-bold px-2 py-0.5 rounded-sm ${
                              exp.type === 'internship' ? 'bg-sky-50 border border-sky-100 text-sky-700' :
                              exp.type === 'practice' ? 'bg-emerald-50 border border-emerald-100 text-emerald-700' :
                              'bg-amber-50 border border-amber-100 text-amber-700'
                            }`}>
                              {exp.type === 'internship' ? '名企实习' :
                               exp.type === 'practice' ? '社会实践' : '学生骨干'}
                            </span>
                          ...
                          <div className="flex flex-wrap items-center gap-2 pt-0.5">
                            ...
                            {exp.stamps && exp.stamps.length > 0 && (
                              <span className="text-[9px] text-emerald-600 font-semibold bg-emerald-50 px-1.5 py-0.5 rounded-sm border border-emerald-100 flex items-center gap-0.5">
